...
namespace Mooseware.Tachnit.AtemApi
{
    public class SwitcherDep
    {
        ...
        private readonly AtemSwitcherDep _atem;
        ...
        public SwitcherDep(string atemIpAddress = "192.168.1.240", string input1 = "CAM1", string input2 = "CAM2",
            string inputMp1 = "MP1", string inputMp2 = "MP2", string inputClip = "PC4")
        {
            ...
            if (IsReady)
            {
                // Get a _switcher object for operating the _switcher...
                _atem = new AtemSwitcherDep(switcher);
